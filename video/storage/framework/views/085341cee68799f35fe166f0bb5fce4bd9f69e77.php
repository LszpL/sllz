  ...
  <nav id="nav">
    <div class="page-width clearfix">
      <ul class="nav-list">
        ...
        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <li class="item">
          <a href="#" class="link">
            <div class="num"><i>887</i></div>
            <?php echo e($item['value']['type_name']); ?>
        ...
        <li class="item item-square">
          ...
          <div class="nav-square__hover">
            ...
            <a href="#" class="activity"><img src="<?php echo e(asset('home_temp/images/cont/nav-square__img.jpg')); ?>" alt="#"></a> -->
          </div>
        </li>
      ...
      <div class="nav-gif"><img src="<?php echo e(asset('home_temp/images/cont/nav_img.gif')); ?>" alt="求领养"></div>
    </div>
  </nav>
    ...
    <div class="page-width clearfix">
      <div class="slider fl">
        <div class="slider-img">
          <a href="#" slider-title="pic1"><img src="<?php echo e(asset('home_temp/images/cont/slider_img1.png')); ?>" alt="#"></a>
          <a href="#" slider-title="pic2"><img src="<?php echo e(asset('home_temp/images/cont/slider_img2.png')); ?>" alt="#"></a>
          <a href="#" slider-title="pic3"><img src="<?php echo e(asset('home_temp/images/cont/slider_img3.png')); ?>" alt="#"></a>
          <a href="#" slider-title="pic4"><img src="<?php echo e(asset('home_temp/images/cont/slider_img4.png')); ?>" alt="#"></a>
        </div>
      ...
      <div class="banner-list fr">
        <ul>
          <li>
            <a href="#">
              <img src="<?php echo e(asset('home_temp/images/cont/main_pic.jpg')); ?>" alt="#">
              <div class="info">
    ...
    <div class="page-width">
      ...
      <div class="mainCont clearfix" id="promote">
        ...
        <div class="main-side fr">
          ...
          <a href="#" class="promote-side__img"><img src="<?php echo e(asset('home_temp/images/cont/main_pic.jpg')); ?>" alt="#"></a>
        </div>
      </div>
          ...
          <ul class="pic-list__wrapper clearfix">
            <li class="item">
              <a href="#" class="img-link">
                ...
                <img class="headImg" src="<?php echo e(asset('home_temp/images/cont/live_headImg1.jpg')); ?>" alt="#">
            ...
            <div class="tab-cont">
              <div class="slider-ov tab-cont__item">
                ...
                <div class="slider-user">
                  <a href="#">
                    <img src="<?php echo e(asset('home_temp/images/cont/slider-user1.jpg')); ?>" alt="#">
                    <p>哔哩老攻</p>
                  </a><a href="#">
                    <img src="<?php echo e(asset('home_temp/images/cont/slider-user2.jpg')); ?>" alt="#">
                    <p>红发杰克丶</p>
                  </a><a href="#">
                    <img src="<?php echo e(asset('home_temp/images/cont/slider-user3.jpg')); ?>" alt="#">
                    <p>麻辣图图</p>
                  </a><a href="#">
                    <img src="<?php echo e(asset('home_temp/images/cont/slider-user4.jpg')); ?>" alt="#">
                    <p>猴叔w</p>
                  </a>
                </div>
              </div>
            ...
            <div class="tab-cont">
              <ul class="tab-cont__item main-rank">
                <li class="item item-one">
                  <a href="#">
                    <i class="n1">1</i>
                    <img src="<?php echo e(asset('home_temp/images/cont/main-rank__img1.jpg')); ?>" alt="#">
                    <div>
              ...
              <ul class="tab-cont__item main-rank">
                <li class="item item-one">
                  <a href="#">
                    <i class="n1">1</i>
                    <img src="<?php echo e(asset('home_temp/images/cont/main-rank__img2.jpg')); ?>" alt="#">
                    <div>
                      <p class="title">【1月】小林家的龙女仆 10【独家正版】</p>
                      <p class="mark">综合评分: 109.3万</p>
                    </div>
        ...
        <div class="pic-list fl" js-tab="true">
          ...
          <div class="weekCont-list">
            <ul class="tab-cont__item tab-cont__cur">
              <li>
                <a href="#" class="pic"><img src="<?php echo e(asset('home_temp/images/cont/main_pic.jpg')); ?>" alt="#"></a>
                <div class="info">
                  <a href="#">珈百璃的堕落</a>
