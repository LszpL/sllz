                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                                ...
                                <?php endif; ?>
                            <form class="am-form am-form-horizontal" action="<?php echo e(url('/admin/admin/insert')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <label><input type="radio" name="admin_auth" value="超级管理员"  <?php if(old('admin_auth')=='超级管理员'): ?> checked="checked" <?php endif; ?>><font class="am-form-label">超级管理员</font></label>
                                    </div>
                                    <div class="am-u-sm-9">
                                        <label><input type="radio" name="admin_auth" value="普通管理员"  <?php if(old('admin_auth')=='普通管理员'): ?> checked="checked" <?php endif; ?>><font class="am-form-label">普通管理员</font></label>
                                    </div>
                                </div>
                                <div class="am-form-group">
