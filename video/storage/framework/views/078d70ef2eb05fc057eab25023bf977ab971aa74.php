<?php $__env->startSection('content'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('home_temp/play/css/video.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('home_temp/play/css/page-core.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('home_temp/play/css/tag-index2.0.css')); ?>" type="text/css" />
    
    
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('home_temp/play/css/comment.min.css')); ?>" />
...
<div class="b-page-body">
        ...
        <div class="viewbox report-scroll-module report-wrap-module" id="viewbox_report">
            <div class="info">
                ...
                <div class="v-title-info" title="投硬币枚数1086">
                    ...
                    <div class="v-title-line v-coin coin_btn" title="投硬币枚数1086">
                        <i class="b-icon b-icon-a b-icon-coin" style="display: block; background-image: url(<?php echo e(asset('home_temp/play/images/anim-coin-small.png')); ?>); width: 60px; height: 60px; background-position: 0px 0px;"></i>
                        <span class="coin-status">硬币</span>
                        <span id="v_ctimes">1086</span>
                    </div>
                    <div class="v-title-line v-stow fav_btn" title="收藏人数5654">
                        <i class="b-icon b-icon-a b-icon-stow" style="display: block; background-image: url(<?php echo e(asset('home_temp/play/images/anim-collect.png')); ?>); width: 60px; height: 60px; background-position: 0px 0px;"></i>
            ...
            <div class="upinfo">
                <div class="u-face" id="r-info-rank">
                    <a href="https://space.bilibili.com/34160092" card="二次元萝莉守护者" mid="34160092" title="二次元萝莉守护者" target="_blank"> <img src="<?php echo e(asset('home_temp/play/images/d405bcf24592e2d080fdc575fa09959434abf0d5.jpg_68x68.jpg')); ?>" alt="二次元萝莉守护者" /> </a>
                </div>
                <div class="r-info">
                    <div class="usname">
    ...
    <div class="player-wrapper">
        ...
        <div class="main-inner">
            ...
            <div class="video-box" unselectable="on" onselectstart="return false;" id='box'>
                ...
                <video  poster="<?php echo e(asset('home_temp/play/images/video-start.jpg')); ?>" id="video" width="100%" height="100%" />
                <source src="<?php echo e(asset('home_temp/play/video/video.mp4')); ?>" type="video/mp4">
        ...
        <div class="arc-toolbar report-scroll-module report-wrap-module" id="arc_toolbar_report">
            ...
            <div class="block fav">
                <span class="t fav_btn" href="//www.bilibili.com/m/stow?aid=10945180" title="收藏人数5654"> <i class="b-icon b-icon-a b-icon-anim-fav" style="display: block; background-image: url(<?php echo e(asset('home_temp/play/images/anim-fav.png')); ?>); width: 80px; height: 80px; background-position: 0px 0px;"></i>
            ...
            <div class="block coin" arctype="Copy" style="display: block;">
                <span class="t" title="投硬币枚数1086"> <i class="b-icon b-icon-a b-icon-anim-coin" style="display: block; background-image: url(<?php echo e(asset('home_temp/play/images/anim-coin-small.png')); ?>); width: 80px; height: 80px; background-position: 0px 0px;"></i>
            ...
            <div class="block watch-later" aid="10945180" title="稍后看">
                <span class="t"> <i class="b-icon b-icon-a b-icon-anim-watch-later" style="display: block; background-image: url(<?php echo e(asset('home_temp/play/images/anim-watch-later.png')); ?>); width: 80px; height: 80px; background-position: 0px 0px;"></i>
                    <div class="t-right">
            ...
            <div class="block app initialized" id="app_qrcode_box" title="用手机看">
                <span class="t"> <i class="b-icon b-icon-a b-icon-anim-app" style="display: block; background-image: url(<?php echo e(asset('home_temp/play/images/anim-app.png')); ?>); width: 80px; height: 80px; background-position: 0px 0px;"></i>
                    <div class="t-right">
                ...
                <div class="qr-code-box report-wrap-module" id="video-report-appdownload">
                    <div class="qr-code-box-inner">
                        ...
                        <div class="qr-bottom">
                            用
                            <a href="https://app.bilibili.com/" target="_blank">哔哩哔哩客户端</a>或其他应用扫描二维码
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="v_small">
            <div class="v-live-recommend">
                ...
                <ul class="v-list-live">
                    <li>
                        <div class="lv-item">
                            <a class="lv-preview" href="https://live.bilibili.com/1313082" target="_blank" title="拥有嗜睡症的人怎么可能睡的醒"> <img data-img="" src="<?php echo e(asset('home_temp/play/images/e2c16cb81703066af2f97a5e30fa93355a1d3915.jpg')); ?>" loaded="loaded" alt="拥有嗜睡症的人怎么可能睡的醒" style="opacity: 1;" />
                                <div class="lv-mask"></div>
                                <div class="b-icon-live-play">
                                    <i class="lv-onair-dot"></i>
                                    <span class="lv-onair-txt">LIVE</span>
                                </div> </a>
                            <a href="https://live.bilibili.com/1313082" target="_blank">
                                <div class="lv-room">
                                    <div class="lv-face">
                                        <img data-img="" src="<?php echo e(asset('home_temp/play/images/9c39b46bd02f75bb15fcd18d264785cef61c81a7.jpg')); ?>" loaded="loaded" style="opacity: 1;" />
                                    </div>
        ...
        <div class="v_large" style="width: 870px;">
            ...
            <div class="v-content">
                <div class="ad ad-e1" b-stat="arc.ad-e1" b-stat-v="" style="overflow: hidden; position: relative; height: 1px; visibility: hidden; display: block;">
                    <a id="a_ds_3" data-id="" data-loc-id="130" data-target-url="" target="_blank" style="display: block; position: relative;"> <img src="<?php echo e(asset('home_temp/play/images/transparent.gif')); ?>" width="870" border="0" height="1" /> </a>
                </div>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av12873848/" target="_blank" title="陈奕迅【十年】全程走音，真的没一个字在调上【当MV去掉BGM后之十年】">
                                    ...
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/2fbb63f83b4141f13c71d01578f64e121df1ef5e.jpg')); ?>" loaded="loaded" alt="陈奕迅【十年】全程走音，真的没一个字在调上【当MV去掉BGM后之十年】" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av12860575/" target="_blank" title="笑死我了，超级歌声模仿秀一个比一个像！">
                                    ...
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/fcaf455133e8782430de4af1276e7dd50d6df90a.jpg')); ?>" loaded="loaded" alt="笑死我了，超级歌声模仿秀一个比一个像！" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av4443282/" target="_blank" title="盘点那些哭的一塌糊涂的演唱会现场">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/048d63d2cc04db3c401a7544af44608384249a1c.jpg')); ?>" loaded="loaded" alt="盘点那些哭的一塌糊涂的演唱会现场" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av788591/" target="_blank" title="豆瓣音乐评分9.9！我是哭着听完的">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/60dc222ef56dd337715fbfe6354d43990911d7c6.jpg')); ?>" loaded="loaded" alt="豆瓣音乐评分9.9！我是哭着听完的" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av11612902/" target="_blank" title="【田馥甄】《痒》把导师都唱酥掉了 听完好痒~">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/31c5d2e96fa14e839679f6fbafe7dfc2eda8fea6.jpg')); ?>" loaded="loaded" alt="【田馥甄】《痒》把导师都唱酥掉了 听完好痒~" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av14218245/" target="_blank" title="新歌声差点就就剩三位导师 陈奕迅竟被那英淘汰？">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/3a9cd1382faaf35771ec419cdc9a67d8403b99d3.jpg')); ?>" loaded="loaded" alt="新歌声差点就就剩三位导师 陈奕迅竟被那英淘汰？" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av11493851/" target="_blank" title="陈奕迅Eason - 浮夸  唱哭韩国粉丝 1440P 超清HD">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/e28e0c3c589bb2fe843afdc5bb6324e7b596b444.jpg')); ?>" loaded="loaded" alt="陈奕迅Eason - 浮夸  唱哭韩国粉丝 1440P 超清HD" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av14125205/" target="_blank" title="全开麦燃炸了！！现场吞cd！！全程高能还有香槟！实力服气！！！">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/6328d05b2535462b17e65aeb9a2ac17f8ab3ccf1.jpg')); ?>" loaded="loaded" alt="全开麦燃炸了！！现场吞cd！！全程高能还有香槟！实力服气！！！" style="opacity: 1;" /> </a>
                        ...
                        <li>
                            <div class="v">
                                <a class="preview" href="https://www.bilibili.com/video/av2556035/" target="_blank" title=" 这么多年，第一次听懂陈奕迅的《你的背包》">
                                    <div class="medal"></div>
                                    <div class="original"></div>
                                    <div class="border"></div> <img data-img="" src="<?php echo e(asset('home_temp/play/images/a367f3086cc482de522136c7cfba0572ab4a6164.jpg')); ?>" loaded="loaded" alt=" 这么多年，第一次听懂陈奕迅的《你的背包》" style="opacity: 1;" /> </a>
            ...
            <div class="common report-scroll-module report-wrap-module" id="common_report">
                <div class="b-head">
                    <span class="b-head-t results" style="display: inline;"><?php echo e($num); ?></span>
                ...
                <div class="comm" id="bbComment" style="position: relative;">
                    <div class="bb-comment ">
                        ...
                        <?php endif; ?>
                            <div class="user-face">
                                <img class="user-head" src="/uploads/<?php echo e(session('uinfo')->face); ?>" />
                            </div>
                        ...
                        <div class="comment-list">
                            <?php $__currentLoopData = $one; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-item reply-wrap " data-id="274921321" data-index="<?php echo e($item->comments_id); ?>">
                                <div class="user-face" data-usercard-mid="2658385">
                                    <a href="javascrypt:;" target="_blank"><img src="/uploads/<?php echo e($item->users_face); ?>" alt="" /></a>
                                </div>
                                <div class="con ">
                                    <div class="user">
                                        <a data-usercard-mid="2658385" href="javascrypt:;" target="_blank" class="name "><?php echo e($item->users_name); ?></a>
                                    </div>
                                    <p class="text"><?php echo e($item->comment); ?></p>
                                    <div class="info">
                                        <span class="floor"></span>
                                        <span class="plad"><a href="https://app.bilibili.com/" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
                                        <span class="time"><?php echo e($item->comment_time); ?></span>
                                        <span class="reply btn-hover btn-highlight">回复</span>
                                    </div>
                                    <div class="reply-box">
                                        <?php $__currentLoopData = $two; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($items->pid == $item->comments_id): ?>
                                        <div class="reply-item reply-wrap" data-id="275050462" data-index="<?php echo e($items->comments_id); ?>">
                                            <a href="javascrypt:;" data-usercard-mid="41384804" target="_blank" class="reply-face"><img src="/uploads/<?php echo e($items->users_face); ?>" alt="" /></a>
                                            <div class="reply-con">
                                                <div class="user">
                                                    <a href="javascrypt:;" target="_blank" data-usercard-mid="41384804" class="name "><?php echo e($items->users_name); ?></a>
                                                    <span class="text-con"><?php echo e($items->comment); ?></span>
                                                </div>
                                                <div class="info">
                                                    <span class="time"><?php echo e($items->comment_time); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="view-more">
                                            共
                                            <b>69</b>条回复,
                                            <a class="btn-more" data-pid="274921321">点击查看</a>
                                        </div>
                                    </div>
                        ...
                        <div class="emoji-tabs">
                            <div class="emoji-container">
                                <div class="emoji-tab-wrap clearfix" style="width: 46px; left: 0px;">
                                    <a class="tab-link on" data-index="0"><img src="<?php echo e(asset('home_temp/play/images/emoji-tab-default.png')); ?>" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="model" class="comment-list" style="display: none;">
        <div class="list-item reply-wrap " data-id="274921321" data-index="<?php echo e($item->comments_id); ?>">
            <div class="user-face" data-usercard-mid="2658385">
                <a href="javascrypt:;" target="_blank"><img src="/uploads/<?php echo e($item->users_face); ?>" alt="" /></a>
            </div>
...
<?php $__env->startSection('js'); ?>
        <script>
            ...
            var flag =1;
            var id = <?php echo e($one['0']->videos_id); ?>;
            ...
            $(".comment-submit").on('click',function () {
                ...
                if(msg == ''){
                    ...
                    $.ajax({
                        ...
                        data:{comment:msg,video_id:id,_token:'<?php echo e(csrf_token()); ?>'},
...
//                        console.log(data);
                            if(data !== 1){
                                ...
                                str.children("div.user-face").children("img").attr('src','/uploads/'+data.users_face);
...
//                                str.children("p.text").html($(".ipt-txt").val());
        ...
        <script src="<?php echo e(asset('home_temp/play/js/video.js')); ?>"></script>
        <script src="<?php echo e(asset('home_temp/play/js/fullScreen.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('home.layouts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>