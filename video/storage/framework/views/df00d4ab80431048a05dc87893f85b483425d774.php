...
<!-- 头部 -->
  ...
  <div class="container" >
    <div class="register-box" style="position:absolute;top:-726px;right:290px;">
      ...
      <form action="<?php echo e(url('/home/dozhuce')); ?>" method="post" >
      <!-- 提示信息 -->
      ...
      <?php echo e(csrf_field()); ?>
        ...
        <div class="cell" >
          ...
          <input type="text" name="login_name" id="js-mobile_ipt" class="text"  value="<?php echo e(old('login_name')); ?>" onclick="layer.tips('请输入11位手机号码','.text',{tips:[2,'#92afed'],time:5000});" />
        </div>
        <div class="cell">
...
function phone(){
  ...
  if(res){
  $.post("<?php echo e(url('/phone')); ?>",{'_token':"<?php echo e(csrf_token()); ?>",'phone':phone,'pwd':pwd,'repwd':repwd},function(data){
    layer.msg(data);
  });
  }else{
    layer.msg('手机号码不存在');
