...
<link rel="stylesheet" href="<?php echo e(asset('home_temp/css/reset.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('home_temp/css/common.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('home_temp/css/index.css')); ?>">

<link href="<?php echo e(asset('home/logins/css/style.css')); ?>" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="<?php echo e(asset('home/logins/js/jquery-1.7.2.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('home/layer/layer.js')); ?>"></script>
                ...
                <div class="game-center header-hover">
                  <div class="c clearfix">
                    <div class="fl">
                      <div class="imgbox">
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/game-center__img1.jpg')); ?>" alt="#">
                          <span>命运-冠位指定（Fate/GO）</span>
                        </a>
                      </div>
                      <div class="game-img">
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/game_img1.png')); ?>" alt="#">
                          <span>刀剑乱舞</span>
                        </a>
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/game_img2.png')); ?>" alt="#">
                          <span>刀剑乱舞</span>
                        </a>
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/game_img3.jpg')); ?>" alt="#">
                          <span>刀剑乱舞</span>
                        </a>
                      </div>
                    </div>
                ...
                <div class="live-box header-hover">
                  <div class="live-box__c">
                    <div class="fl">
                      ...
                      <div class="cont">
                     <!--    <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/live-box__img1.jpg')); ?>" alt="#">
                          <i>LIVE</i>
                          <p>热爱电竞の三三</p>
                        </a> -->
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/live-box__img2.jpg')); ?>" alt="#">
                          <i>LIVE</i>
                          <p>大角虫漫画</p>
                        </a>
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/live-box__img3.jpg')); ?>" alt="#">
                          <i>LIVE</i>
                          <p>木本青</p>
                        </a>
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/live-box__img4.gif')); ?>" alt="#">
                          <i>LIVE</i>
                          <p>一只小鹿噜噜噜</p>
                        </a>
                     <!--    <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/live-box__img5.jpg')); ?>" alt="#">
                          <i>LIVE</i>
                          <p>污叶妹屮</p>
                        </a> -->
                        <a href="#">
                          <img src="<?php echo e(asset('home_temp/images/cont/live-box__img6.jpg')); ?>" alt="#">
                          <i>LIVE</i>
                          <p>污污_永远的魔法师_</p>
                        </a>
                      </div>
  ...
  <div class="container">
    <div class="register-box">
      <div class="reg-slogan">
        ...
        <form action="<?php echo e(url('/home/dologin')); ?>" method="post">
        <!-- 提示信息 -->
        ...
        <?php echo e(csrf_field()); ?>
          ...
          <div class="cell">
            ...
            <input type="text" name="login_name" id="js-mobile_ipt" class="text"  value="<?php echo e(old('login_name')); ?>" onclick="layer.tips('请输入11位手机号码','.text',{tips:[1,'#92afed'],time:3000});" />
          </div>
          <br>
          <div class="cell">
          ...
          <div class="cell vcode">
            ...
            <input type="text" name="code" id="js-mobile_vcode_ipt" class="text cd" maxlength="6" onclick="layer.tips('请输入4位验证码','.cd',{tips:[1,'#92afed'],time:3000});" />
              ...
              <img src="<?php echo e(URL('/code/captcha/1')); ?>" id="127ddf0de5a04167a9e427d883690ff6" >  
              </a>
          </div>
            <button type="submit" id="js-mobile_btn"  class="button btn-green">
            立即登录</button>

            <a href="<?php echo e(url('/home/zhuce')); ?>"><button type="button" class="button btn-white" style="position: absolute;bottom:77px;right: 35px;">
         ...
         <li class="footer-icon">
           <div class="cont">
             <a href="#" class="app">
               <i></i>
               <em>手机端下载</em>
               <img src="<?php echo e(asset('home_temp/images/app-qrcode.png')); ?>" alt="#">
             </a>
             <a href="#" class="weibo">
               <i></i>
               <em>新浪微博</em>
               <img src="<?php echo e(asset('home_temp/images/weibo-qrcode.png')); ?>" alt="#">
             </a>
             <a href="#" class="weixin">
               <i></i>
               <em>官方微信</em>
               <img src="<?php echo e(asset('home_temp/images/weixin-arcode.gif')); ?>" alt="#">
             </a>
           </div>
         </li>
      </ul>
