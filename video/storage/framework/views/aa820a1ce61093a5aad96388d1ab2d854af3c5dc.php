<?php $__env->startSection('content'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('home_temp/history/css/reset.css')); ?>">
    
    <script src="<?php echo e(asset('home_temp/history/js/vendor_34cd10da.js')); ?>"></script>
    
    
    
    
    <script src="<?php echo e(asset('home_temp/history/js/app_34cd10da.js')); ?>"></script>
                    ...
                    <li class="history-record todayitem">
                        <div class="l-info">
                            <div class="lastplay-time">
                                ...
                                <span class="lastplay-t"><?php echo e(substr($item->last_time,0,10)); ?></span>
                            </div>
                        </div>
                        <div class="r-info clearfix">
                            <div class="cover-contain">
                                <a class="preview">
                                    <img src="/<?php echo e($item->video_img); ?>">
                                </a>
                                <div class="info"> </div>
                            ...
                            <div class="r-txt">
                                <a class="title"><?php echo e($item->video_name); ?></a>
                                ...
                                <div class="w-info">
                                    <div class="time-wrap">
                                        ...
                                        <a>
                                            ...
                                            <span style="margin-left: 106px;" class="username"><?php echo e($item->admin_name); ?></span>
                                        </a>
                                    </div>

                                </div>
                                
                                <a value="<?php echo e($item->watchs_id); ?>" href="javascript:;" onclick="del(this);" ><i class="history-delete"></i></a>
                            </div>
                        </div>
                    </li>
